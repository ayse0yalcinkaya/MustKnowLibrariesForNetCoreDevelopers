...
namespace Solid.App.SRP.Bad
{
    public class Product
    {
        ...
        private static List<Product> ProductList = new List<Product>(); //newle nesne örneği olmaması için static dedik
        ...
        {
            ProductList.ForEach(x => Console.WriteLine($"Id: {x.Id} - Name: {x.Name}"));
        }
    }
}
